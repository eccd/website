...
class RSFormModelSubmissions extends JModelLegacy
{
	...
	public function __construct()
	{
		...
		$this->setState('com_rsform.submissions.'.$this->formId.'.limit', $limit);
		$this->setState('com_rsform.submissions.'.$this->formId.'.limitstart', $limitstart);
	...
	public function getFilter() {
		...
		return $app->getUserStateFromRequest('com_rsform.submissions.form'.$formId.'.filter', 'filter', '');
	}
