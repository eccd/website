...
class JFormFieldPweb extends JFormFieldRadio
{
	...
	protected $home = 'http://www.perfect-web.co/joomla/link-with-article-images-facebook?utm_source=upgrade_to_pro&utm_medium=referral&utm_name=upgrade_to_pro';
	...
	{		
		...
		if ($this->value)
		{
			...
			$doc->addScriptDeclaration(
				...
				'pw.src="//www.perfect-web.co/updates/feed.js?ext='.$this->extension.'&v='.$manifest->get('version', '2.0.0').'&j='.JVERSION.'";'.
