...
function add_marker_on_map(id, i, w_long, w_lat, w_info, dragb)
{
	...
	if(w_long==null)
	{
		...
		w_lat=gmapdata[id].getCenter().lng();
		w_long=gmapdata[id].getCenter().lat();
	}
	else
	...
	if(document.getElementById("longval"+i))
	{
		document.getElementById("longval"+i).value = w_lat;
		document.getElementById("latval"+i).value =w_long ;
