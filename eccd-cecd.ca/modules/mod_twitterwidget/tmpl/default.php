...
<div id="twitter-container">
	<div id="twitter">
		...
		<div id="twitter-header">
			...
			<?php if($params->get('type', 1)) : ?>
				<a href="https://twitter.com/<?php echo $data->tweets[0]->screenName; ?>" target="_blank">
					<img src="<?php echo $data->tweets[0]->profileImage; ?>" class="twitter-avatar" />
					<span class="twitter-display-name"><?php echo $data->tweets[0]->displayName; ?></span>
					<span class='twitter-screen-name'> @<?php echo $data->tweets[0]->screenName; ?></span>
				</a>
		...
		<div id="twitter-tweets">
			...
			<div class="twitter-tweet-container <?php echo end(array_keys($data->tweets)) == $key?' twitter-last':'';?>">
				<?php if($params->get('avatars', 1)): ?>
					<div>
						<a href="https://twitter.com/intent/user?screen_name=<?php echo $tweet->screenName; ?>" target="_blank">
							<img src="<?php echo $tweet->profileImage; ?>" class="twitter-avatar" style="width: 35px;" />
						</a>
					</div>
					<div class="twitter-tweet" style="padding-left: 40px;">
						<?php else: ?>
