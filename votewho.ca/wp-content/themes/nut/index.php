...
<?php if ( is_home() ) { ?>
<?php if(of_get_option('welcome2_enable','nut') == "1"){ ?>
<div class="  warp row">
<div class=" large-12">
...
<?php if(of_get_option('blocks_checkbox','nut') == "1"){ ?>
...
<?php if( get_option( 'nut' )){ ?>
<?php if(of_get_option('recentwork_checkbox','Nut') == "1"){ ?>
...
<?php if ( is_home() ) { ?>
<?php if(of_get_option('welcome1_enable','nut') == "1"){ ?>
<div class="  warp row">
<div class=" large-12">
<?php if ( of_get_option('hathor_welcome') ) : ?>
<section id="callout">
...
<?php }else{ ?>
 ...
 <?php get_template_part('dummy/dummy','layout2'); ?>
        <?php } ?> 
...
<!--Our client-->
<?php if( get_option( 'nut' )){ ?>
<?php if(of_get_option('ourclient_checkbox','nut') == "1"){ ?>
 <div class="row "> 
