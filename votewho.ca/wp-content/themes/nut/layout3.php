					...
					<article class="post_format_standard odd">
                        ...
                        <?php if(of_get_option('dissauth_checkbox') == "0"){ ?>
                           ...
                           <?php if( has_category() ) { ?>
							...
							<?php } ?><?php } ?>
                          <div class="post_comments"><a><span class="comments_number"> <?php comments_popup_link( __( 'No comments', 'hathor' ), __( '1 Comment', 'nut' ), __( '% Comments', 'hathor' )); ?> </span><span class="icon-comment"></span></a></div>  
